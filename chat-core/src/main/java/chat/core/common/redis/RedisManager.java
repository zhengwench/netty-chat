package chat.core.common.redis;

import chat.core.common.utility.CommonPropertiesUtility;
...
public class RedisManager {
    ...
    public static void getJedisPool(){
        ...
        jedisPool=new JedisPool(jedisPoolConfig,CommonPropertiesUtility.getProperty("redis.host"),
                Integer.parseInt(CommonPropertiesUtility.getProperty("redis.port")),2000,
                CommonPropertiesUtility.getProperty("redis.password"));
    }
    ...
    public static long setnx(String key, String xvalue) {
        ...
        try {
            ...
            logger.error("setnx redis,失败key=" + key, e);
        } finally {
            returnResource(jedis);
        }
        return result;
